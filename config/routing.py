...
"""
用于websockt认证，继承了CookieMiddleware，SessionMiddleware，AuthMiddleware，兼容了Django的认证系统
"""
...
application = ProtocolTypeRouter({
    # "http":views（视图）  # 普通的HTTP请求不需要我们手动在这里添加，框架会自动加载

    # AllowedHostsOriginValidator 读取我们在.env中定义的DJANGO_ALLOWED_HOSTS，读取允许的的IP和域名
    # from channels.security.websocket import OriginValidator 需要自定义 允许的域名 与ip
